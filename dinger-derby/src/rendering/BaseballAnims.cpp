...
AnimationClip yamamotoWindup(const SkinnedModel3D& model) {
    ...
    // Hips: closed → open through plant/release
    pushRot(clip, J("Hips"), kTimes, {
        eul(0.00f, -0.05f, 0.0f),
        eul(0.02f, -0.18f, -0.04f),
        eul(0.00f, -0.30f, -0.03f),
        eul(0.00f, -0.38f, -0.02f),
        eul(0.00f, -0.40f, -0.02f),
        eul(0.04f, -0.22f, 0.0f),
        eul(0.08f, 0.05f, 0.02f),
        eul(0.10f, 0.25f, 0.04f),
        eul(0.12f, 0.45f, 0.05f), // release
    ...
    pushRot(clip, J("Spine"), kTimes, {
        eul(0.04f, 0.0f, 0.0f),
        eul(0.05f, -0.08f, -0.03f),
        eul(0.03f, -0.15f, -0.03f),
        eul(0.02f, -0.20f, -0.02f),
        eul(0.02f, -0.22f, -0.02f),
        eul(0.06f, -0.18f, -0.01f),
        eul(0.10f, -0.12f, 0.0f),
        eul(0.12f, 0.02f, 0.02f),
        eul(0.14f, 0.28f, 0.04f),
        eul(0.16f, 0.40f, 0.05f),
        eul(0.10f, 0.25f, 0.02f),
        eul(0.06f, 0.12f, 0.0f)
    });
    pushRot(clip, J("Chest"), kTimes, {
        eul(0.02f, 0.0f, 0.0f),
        eul(0.03f, -0.06f, -0.02f),
        eul(0.02f, -0.12f, -0.02f),
        eul(0.01f, -0.18f, -0.02f),
        eul(0.01f, -0.20f, -0.02f),
        eul(0.04f, -0.22f, -0.01f), // still closed at hand break
        eul(0.06f, -0.18f, 0.0f),
        eul(0.08f, -0.05f, 0.02f),
        eul(0.10f, 0.35f, 0.05f), // fire
        eul(0.12f, 0.50f, 0.06f),
        eul(0.08f, 0.30f, 0.03f),
        eul(0.04f, 0.15f, 0.0f)
    });

    // Head: locked on target through lift, slight nod at release
    pushRot(clip, J("Head"), kTimes, {
        eul(0.0f, 0.0f, 0.0f),
        eul(0.0f, 0.04f, 0.0f),
        eul(-0.02f, 0.06f, 0.0f),
        eul(-0.03f, 0.07f, 0.0f),
        eul(-0.03f, 0.08f, 0.0f),
        eul(0.0f, 0.05f, 0.0f),
        eul(0.02f, 0.04f, 0.0f),
        eul(0.04f, 0.02f, 0.0f),
        eul(0.08f, 0.0f, 0.0f),
        eul(0.06f, -0.08f, 0.0f),
        eul(0.03f, -0.04f, 0.0f),
        eul(0.0f, 0.0f, 0.0f)
    });

    // Lead leg (Hip_L / Knee_L): rest bone is along -Y.
    // Negative Rx swings the thigh up/forward (+Z); peak kick ~ -1.55 rad.
    pushRot(clip, J("Hip_L"), kTimes, {
        eul(-0.08f, 0.0f, 0.04f),
        eul(-0.45f, 0.05f, 0.06f),
        eul(-1.05f, 0.08f, 0.08f),
        eul(-1.55f, 0.10f, 0.06f), // peak kick — knee near chest
        eul(-1.58f, 0.10f, 0.06f), // hold
        eul(-0.95f, 0.05f, 0.04f),
        eul(-0.35f, 0.0f, 0.02f),
        eul(-0.08f, -0.02f, 0.0f),
        eul(-0.04f, -0.04f, 0.0f),
        eul(-0.04f, -0.04f, 0.0f),
        eul(-0.06f, -0.02f, 0.0f),
        eul(-0.05f, 0.0f, 0.0f)
    });
    // Knee flex keeps foot tucked under on the kick (positive Rx folds shin).
    ...
    // Drive lead foot forward during stride via hip translation on Hips
    ...
    pushRot(clip, J("Hip_R"), kTimes, {
        eul(0.08f, 0.0f, -0.04f),
        eul(0.12f, 0.0f, -0.05f),
        eul(0.14f, 0.0f, -0.05f),
        eul(0.16f, 0.0f, -0.04f),
        eul(0.18f, 0.0f, -0.04f),
        eul(0.25f, 0.0f, -0.02f),
        eul(0.32f, 0.0f, 0.0f),
        eul(0.35f, 0.0f, 0.02f),
    ...
    // Glove arm (L): stays tucked / hands together until break, then chest tuck
    pushRot(clip, J("Shoulder_L"), kTimes, {
        eul(0.55f, 0.35f, 0.15f), // set hands chest
        eul(0.58f, 0.38f, 0.15f),
        eul(0.62f, 0.40f, 0.15f),
        eul(0.65f, 0.42f, 0.15f),
        eul(0.65f, 0.42f, 0.15f),
        eul(0.40f, 0.20f, 0.05f), // break
        eul(0.25f, 0.05f, -0.05f),
        eul(0.20f, -0.05f, -0.08f),
        eul(0.18f, -0.10f, -0.10f), // tucked
        eul(0.22f, -0.05f, -0.05f),
        eul(0.30f, 0.05f, 0.0f),
        eul(0.40f, 0.15f, 0.05f)
    });
    ...
    // Throw arm (R): rest hangs along -Y. Negative Rx lifts forward (+Z);
    // positive Ry swings open/closed. Set keeps hand near sternum via elbow bend.
    pushRot(clip, J("Shoulder_R"), kTimes, {
        eul(-0.55f, 0.35f, 0.25f),  // set — raised, inward
        eul(-0.55f, 0.38f, 0.25f),
        eul(-0.58f, 0.40f, 0.25f),
        eul(-0.58f, 0.40f, 0.25f),
        eul(-0.58f, 0.40f, 0.25f),
        eul(-0.35f, -0.55f, -0.20f), // break — starts cocking back
        eul(0.25f, -1.05f, -0.45f),  // layback high-back
        eul(0.10f, -0.85f, -0.35f),  // plant / max ER
        eul(-1.25f, 0.15f, 0.20f),   // RELEASE — high 3/4 out front
        eul(-0.95f, 0.55f, 0.40f),   // follow across
        eul(-0.50f, 0.35f, 0.20f),
        eul(-0.35f, 0.15f, 0.08f)
    });
...
AnimationClip pitcherIdle(const SkinnedModel3D& model) {
    ...
    pushRot(clip, J("Spine"), times, {
        eul(0.04f, 0.0f, 0.0f),
        eul(0.05f, 0.02f, 0.01f),
        eul(0.04f, 0.0f, 0.0f)
    });
    pushRot(clip, J("Shoulder_R"), times, {
        eul(0.50f, -0.25f, -0.10f),
        eul(0.52f, -0.25f, -0.10f),
        eul(0.50f, -0.25f, -0.10f)
    });
    pushRot(clip, J("Shoulder_L"), times, {
        eul(0.55f, 0.35f, 0.15f),
        eul(0.57f, 0.35f, 0.15f),
        eul(0.55f, 0.35f, 0.15f)
    });
    pushRot(clip, J("Elbow_R"), times, {
        eul(1.15f, 0.0f, 0.0f), eul(1.18f, 0.0f, 0.0f), eul(1.15f, 0.0f, 0.0f)
    });
    pushRot(clip, J("Elbow_L"), times, {
        eul(1.20f, 0.0f, 0.0f), eul(1.22f, 0.0f, 0.0f), eul(1.20f, 0.0f, 0.0f)
    });
    return clip;
}
